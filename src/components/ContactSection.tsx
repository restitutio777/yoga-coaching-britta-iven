...
function CalendlyBooking() {
  return (
    <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 md:p-10 flex flex-col items-center text-center">
      {/* Calendar icon */}
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16">
          ...
          <div>
            ...
            {/* Form tab */}
            {activeTab === "form" && (
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 md:p-10">
