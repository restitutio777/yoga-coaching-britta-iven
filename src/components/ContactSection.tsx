              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-warm-gray">
                    Online (Zoom) & vor Ort nach Vereinbarung
                  </p>
                </div>
              </div>
          ...
          <div className="bg-white p-8 md:p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                <label
                  htmlFor="name"
                  className="block text-sm text-warm-gray mb-2"
                >
                  Name
                </label>
                <input
              ...
              <div>
                <label
                  ...
                  className="block text-sm text-warm-gray mb-2"
                >
                  Deine Situation (optional)
                </label>
                <select
                  id="situation"
                  value={formState.situation}
                  onChange={(e) =>
                    setFormState({ ...formState, situation: e.target.value })
                  }
                  className="w-full px-4 py-3 bg-cream border border-border text-warm-dark text-sm focus:outline-none focus:border-sage transition-colors"
                >
                  <option value="">Bitte wahlen...</option>
                  <option value="akut">Akute Kundalini-Krise</option>
                  <option value="symptome">
                    Unklare Symptome nach spiritueller Praxis
                  </option>
              ...
              <p className="text-xs text-warm-light text-center">
                Deine Daten werden vertraulich behandelt und nicht an Dritte
                weitergegeben.
              </p>
            </form>
          </div>
